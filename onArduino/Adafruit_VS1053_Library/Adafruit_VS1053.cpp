...
//using this constructor for admixer plug in ex
Adafruit_VS1053_FilePlayer::Adafruit_VS1053_FilePlayer(
...
//this inherited constructor called
...
uint16_t Adafruit_VS1053::loadPlugin(char *plugname) {
  ...
  //uint8_t mode = 0x0000; //clear bit to use MIC 
...
int Adafruit_VS1053::sineTest(uint8_t n, uint16_t ms) {
  //
  reset();
