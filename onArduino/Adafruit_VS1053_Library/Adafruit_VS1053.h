...
class Adafruit_VS1053 {
 public:
  ...
  int sineTest(uint8_t n, uint16_t ms);
...
protected:
public: //private:
  uint8_t  _dreq; //originally protected
...
class Adafruit_VS1053_FilePlayer : public Adafruit_VS1053 {
 public:
  ...
  static boolean isWAVFile(const char* fileName);
...
const unsigned char HelloMP3[] = { // Note: "code" in AT89C51 SDCC means to put this array into ROM.
